    ...
    <?php } else { ?>
        ...
        <div class="container-fluid fluid-height wrapper">
            <div class="row columns content">
                <div class="left-column article-tree col-sm-3 col-md-2 hidden-print">
                    <!-- For Mobile -->
                    <div id="sub-nav-collapse" class="sub-nav-collapse">
                      <div class="PageHeader">
                        ...
                        <a class="PageHeader-logo" href="<?php echo $index;?>.html"><?php echo $project_title; ?></a>
                      </div>
                        <!-- Navigation -->
                        <?php
                ...
                <div class="right-column <?php echo ($params['float']?'float-view':''); ?> content-area col-sm-9 col-md-10">
                            ...
                            <?php if ($params['date_modified']) { ?>
                                <div class="page-top">
                                  ...
                                  <p class="page-metadata">
                                      <?php echo date("l, F j, Y", $page['modified_time']);?> <?php echo date("g:i A", $page['modified_time']);?>
                                  </p>
                                </div>
                            <?php } else { ?>
                              <div class="page-top">
